      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          ...
          <div className="text-center mt-20">
            <h1 className="text-large font-bold text-gray-600 dark:text-gray-300">No notes yet</h1>
            <h2 className="text-gray-500 dark:text-gray-400">Start by adding your first note!</h2>
          </div>
        )}
      </div>
